    ...
    return (
        <section id="hero" className="bg-cream pt-24 pb-6
         px-12 flex flex-col gap-6 font-cabin relative">
            <div className="bg-cream text-gray-400 border border-slate-200 rounded-full text-center w-1/2  shadow-[3px_3px_0_#e8e0d4] flex justify-center items-center gap-1 md:w-1/4">
            <span className="w-4 h-4 bg-green-500 border rounded-[50%] animate-greenPulse "></span>
            Available for opportunities</div>
            <h1 className="font-fraunces text-2xl font-semibol md:text-7xl md:leading-snug "> Hi, I'm <em className="text-red-400">Tamara</em> -
            <br />
            ...
            <div className="flex gap-4">
                ...
                py-1 w-fit text-nowrap">See my work<span>✦</span></a>
                <a href="#contact" className="border-2 text-sm border-dark-navy rounded-3xl px-6 py-1 w-fit text-nowrap">Say hello</a>
